    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10 text-center">
        ...
        <h1
          ...
          style={{ color: "#FFFFFF" }}
        >
          We built XYZ Labs because we hated seeing good teams held back by bad
          systems.
        </h1>
        ...
        <div ref={subContentRef}>
          ...
          <div className="mt-16 flex items-center justify-center gap-4 text-white/20 font-mono text-[10px] tracking-[0.2em] uppercase">
